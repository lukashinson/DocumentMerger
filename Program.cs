...
namespace DocumentMerger
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                Console.WriteLine("");
                sourceFilePath1 = GetSourceTextFilePath("Enter path to 1st text file to merge: ");
                sourceFilePath2 = GetSourceTextFilePath("Enter path to 2nd text file to merge: ");
        ...
        static string GetSourceTextFilePath(string prompt)
        {
            ...
            do
            {
                ...
                Console.Write("The provided source file path cannot be found. Please enter again: ");
            } while (true);
        }
